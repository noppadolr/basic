        ...
        <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="customers">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('customer/customer1') }}" class="nav-link">customer1</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('customer/customer2') }}" class="nav-link">customer2</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('customer/customer3') }}" class="nav-link">customer3</a>
                        </li>
                    </ul>
                </div>
            </li>
